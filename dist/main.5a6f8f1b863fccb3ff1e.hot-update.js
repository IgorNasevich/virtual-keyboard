...
document.addEventListener("keydown", (event)=>{
    if(event.code === "ShiftLeft"){
        if(document.querySelector('#keyboard .keyboard-key[data="controlleft"]').classList.contains('pressed')){
            localStorage.setItem('flag', !localStorage.getItem('flag'));
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d2211546b599397172c6")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.5a6f8f1b863fccb3ff1e.hot-update.js.map