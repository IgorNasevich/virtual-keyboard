    ...
    element.addEventListener('mousedown', (event)=>{
        ...
        if(event.code === "AltLeft"){
            ...
            if(event.shiftKey === true){
                let code = element.getAttribute('data').toUpperCase();
                textarea.value += code;
            }
            else{
            ...
            if(document.querySelector('#keyboard .keyboard-key[data="capslock"]').classList.contains('pressed')){
                let code = element.getAttribute('data').toUpperCase();
                textarea.value += code;
            }
            else{
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ce0a542815677bb49a2f")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.5a5b67adf015260b668f.hot-update.js.map