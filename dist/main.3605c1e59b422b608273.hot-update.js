...
function init(){
    ...
    for(let i = 0; i < keyboardEng.length; i ++){
        if(keyboardEng[i] === 'Ctrl'){
            ...
            out+='<div class ="keyboard-key" data = "\\">' + keyboardEng[i] + '</div>';
        }
        else{
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("bdb5c567ca5741484a65")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.3605c1e59b422b608273.hot-update.js.map