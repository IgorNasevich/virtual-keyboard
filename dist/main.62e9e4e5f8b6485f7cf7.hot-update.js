...
document.addEventListener("keydown", (event)=>{
    if(event.code === "ShiftLeft"){
        if(document.querySelector('#keyboard .keyboard-key[data="controlleft"]').classList.contains('pressed')){
            localStorage.setItem('flag', !Object.values(localStorage['flag']));
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("44bd3d8231aea79189c7")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.62e9e4e5f8b6485f7cf7.hot-update.js.map