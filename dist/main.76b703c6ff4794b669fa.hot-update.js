...
document.addEventListener("keydown", (event)=>{
    if(event.code === "ShiftLeft"){
        if(document.querySelector('#keyboard .keyboard-key[data="controlleft"]').classList.contains('pressed')){
            ...
            localStorage.setItem('flag', !Boolean(localStorage.getItem('flag')));
            console.log(localStorage.getItem('flag'));
            if(localStorage.getItem('flag') === "true"){
                arr = keyboardEng;
            }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("654b57e64118bd750ca1")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.76b703c6ff4794b669fa.hot-update.js.map