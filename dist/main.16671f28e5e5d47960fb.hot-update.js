...
document.addEventListener("keydown", (event)=>{
    if(event.code === "ShiftRight"){
        if(document.querySelector('#keyboard .keyboard-key[data="controlright"]').classList.contains('pressed')){
            flag = false;
        }
    }
}) 
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("bc1655a8d8f02540b364")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.16671f28e5e5d47960fb.hot-update.js.map