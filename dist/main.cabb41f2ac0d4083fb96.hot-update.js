...
let keyboardEng = ['`', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '-', '=', 'Backspace', 'Tab', 'Q', 'W', 'E', 'R', 'T', 'Y', 'U', 'I', 'O', 'P', '[', ']', '\\', 'Delete', 'CapsLock', 'A', 'S', 'D', 'F', 'G', 'H', 'J', 'K', 'L', ';', "'", 'Enter', 'Shift', 'Z', 'X', 'C', 'V', 'B', 'N', 'M', ',', '.', '/','↑', 'Shift', 'Control', 'Win', 'Alt', ' ', 'Alt', 'Control', '←', '↓', '→'];
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("97846e8c146653f0b2bd")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.cabb41f2ac0d4083fb96.hot-update.js.map