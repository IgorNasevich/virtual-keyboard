...
const keyboardRus = ["Ё", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-", "=", "Backspace", "Tab", "Й", "Ц", "У", "К", "Е", "Н", "Г", "Ш", "Щ", "З", "Х", "Ъ", "Del", "CapsLock", "Ф", "Ы", "В", "А", "П", "Р", "О", "Л", "Д", "Ж", "Э", "Enter", "Shift", "Я", "Ч", "С", "М", "И", "Т", "Ь", "Б", "Ю", ".", "↑", "Shift", "Ctrl", "Win", "Alt", " ", "Alt", "Ctrl", "←", "↓", "→"];
const keyboardEng = ["`", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-", "=", "Backspace", "Tab", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "[", "]", "Del", "CapsLock", "A", "S", "D", "F", "G", "H", "J", "K", "L", ";", "'", "Enter", "Shift", "Z", "X", "C", "V", "B", "N", "M", ",", ".", "/", "↑", "Shift", "Ctrl", "Win", "Alt", " ", "Alt", "Ctrl", "←", "↓", "→"];
const keyCode = [192, 49, 50, 51, 52, 53, 54, 55, 56, 57, 48, 189, 187, 8, 9,
  81, 87, 69, 82, 84, 89, 85, 73, 79, 80, 219, 221, 46, 20, 65, 83, 68, 70, 71, 72,
  74, 75, 76, 186, 222, 13, 16, 90, 88, 67, 86, 66, 78, 77, 188, 190, 191, 38, 1600, 17,
  91, 18, 32, 1800, 1700, 37, 40, 39];
...
function init(arr) {
  ...
  document.onkeydown = function ev1(event) {
    let code = "";
    ...
    if (localStorage.getItem("language") === "rus") {
      if (event.code === "CapsLock") {
        ...
        if (event.code === "AltLeft") {
          ...
          textarea.value = textarea.value.substring(0, position - 1)
          + textarea.value.substring(position, textarea.value.length);
          position -= 2;
          ...
          const element = document.querySelector(`#keyboard .keyboard-key[data="${event.keyCode}"]`);
          ...
          } else if (event.shiftKey === true || document.querySelector("#keyboard .keyboard-key[data=\"20\"]").classList.contains("pressed")) {
        ...
        if (!(event.code === "Backspace" || event.code === "Delete")) {
          const pt1 = textarea.value.substring(0, position);
          const pt2 = textarea.value.substring(position, textarea.value.length);
      ...
      if (!(event.code === "Backspace" || event.code === "Delete")) {
        textarea.value = textarea.value.substring(0, position) + code
        + textarea.value.substring(position, textarea.value.length);
      }
      position += 1;
    }
  ...
  document.onkeyup = function ev2(event) {
    if (event.code === "CapsLock") {
      position += 1;
      position -= 1;
